...
public class EventManagerScript : MonoBehaviour
{
    ...
    //Take note that the events defined below the delegates take similarly named delegates so they are linked. For example GameOverEventDelegate() goes with GameOverEvent.
    #region delegates
    ...
    //play game over sfx will play, and a menu manager will display options for trying the level again or going back to the main menu
    #region events
